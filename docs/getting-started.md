...
Details: [Core package guide](packages/laravel-capabilities.md#peers-laravelai--laravelmcp) and core package README.
...
→ [Messaging package guide](packages/laravel-capabilities-messaging.md)
...
→ [CLI package guide](packages/capabilities-cli.md)
