...
Cross-compile targets (darwin/linux/windows × amd64/arm64): see [`dist/README.md`](../../packages/capabilities-cli/dist/README.md).
...
- [Package README](../../packages/capabilities-cli/README.md)
- [CHANGELOG](../../packages/capabilities-cli/CHANGELOG.md)
