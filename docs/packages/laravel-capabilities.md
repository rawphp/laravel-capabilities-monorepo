...
Package-specific peer matrix and D-020 detail also live in the [package README](../../packages/laravel-capabilities/README.md). Full design: [spec.md](../spec.md).

## Before you start

- Install via monorepo path or VCS — [Getting started](../getting-started.md) · [versioning.md](../versioning.md)
...
Full teaching sample: [First capability tutorial](../tutorials/first-capability.md).
...
Maintainer filters (from monorepo root): see [package README — Peer support](../../packages/laravel-capabilities/README.md#peer-support--d-011-release-gate).
...
Deep state machine detail: [spec.md](../spec.md).
...
- [Package README](../../packages/laravel-capabilities/README.md)
- [CHANGELOG](../../packages/laravel-capabilities/CHANGELOG.md)
