...
- **Generator (do not hand-edit stubs):** `python3 tools/generate_requirement_stubs.py` regenerates inventory + package stubs together. Extend the catalog in that script, then re-run.
