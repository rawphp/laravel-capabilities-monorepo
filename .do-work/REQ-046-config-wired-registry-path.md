...
**Priority:** 3
**Size:** M
**Files:** packages/laravel-capabilities/src/Boot/ContainerBindings.php, packages/laravel-capabilities/src/CapabilitiesServiceProvider.php, packages/laravel-capabilities/tests/Unit/Boot/
...
- [ ] Path-unit children REQ-047 and REQ-048 are done and archived
- [ ] Unit evidence shows container-resolved registry shares configured stores and applies listed config domains
- [ ] Dual ApprovalManager/idempotency store divergence is covered by a failing-then-passing unit scenario
